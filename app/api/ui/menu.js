...
module.exports = [
  ...
  },
  {
    ...
    child: [
      ...
      {
        key: 'blank',
        name:'Blank Page', /*<FormattedMessage {...messages.blank} />,  'Blank Page', */
        icon: 'video_label',
      ...
      },
      {
        ...
        name: 'Department',
        icon: 'video_label',
        link: '/app/pages/Payroll/Department/DepartmentList'
      },
      {
        key: 'Section',
        name: 'Section',
        icon: 'video_label',
        link: '/app/pages/Payroll/Section/SectionList'
      },
      {
        key: 'Gender',
        name: 'Gender',
        icon: 'video_label',
        link: '/app/Pages/MainData/Gender'
      },
	    {
        key: 'Grade',
        name: 'Grade',
        icon: 'video_label',
        link: '/app/Pages/MainData/Grade'
      },
      {
        key: 'gallery',
        name: 'Photo Gallery',
