        ...
        <Grid container spacing={3} alignItems="flex-start" direction="row">
                    ...
                    >
                      ...
                      <Grid item xs={12} md={12}>
                        <FormControlLabel
                          ...
                          label={intl.formatMessage(
                            messages.trainingPeriodHasBalance
                          )}
                        />
                      </Grid>
                      <Grid item xs={12} md={12}>
                        <FormControlLabel
                          ...
                          label={intl.formatMessage(messages.excludeVacDays)}
                        />
                      </Grid>
                      <Grid item xs={12} md={12}>
                        <FormControlLabel
                          ...
                          label={intl.formatMessage(messages.vacBalaMonthly)}
                        />
                      </Grid>
                      <Grid item xs={12} md={12}>
                        <FormControlLabel
                    ...
                    >
                      ...
                      <Grid item xs={12} md={12}>
                        <FormControlLabel
                          ...
                          label={intl.formatMessage(messages.calcVacAuto)}
                        />
                      </Grid>
                      ...
                      <Grid item md={6} xs={12}>
                        <TextField
                          ...
                          onChange={(e) => handleChange(e)}
                          label={intl.formatMessage(messages.workDays)}
                          className={classes.field}
                          variant="outlined"
                          autoComplete="off"
                        />
                      ...
                      <Grid item md={6} xs={12}>
                        <TextField
                          ...
                          onChange={(e) => handleChange(e)}
                          label={intl.formatMessage(messages.vacEquiv)}
                          className={classes.field}
                          variant="outlined"
                          autoComplete="off"
                        />
          ...
          <Grid item md={4} xs={12}>
            <Autocomplete
              ...
              value={
                group1ElemList.find((item) => item.id === data.vacPenEle) ||
                null
              }
              isOptionEqualToValue={(option, value) =>
