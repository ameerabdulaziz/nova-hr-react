...
async function oncancel(){
  ...
  return (
    <div>
        <PapperBlock whiteBg icon="border_color" title={data.id==0?intl.formatMessage(messages.EmployeeShiftCreateTitle)+"  ("+employeeName+")":intl.formatMessage(messages.EmployeeShiftUpdateTitle)+"  ("+employeeName+")"} desc={""}>
