...
function ShiftTransfere(props) {
  ...
  const [OLdFromData, setOLdFromData] = useState(format(new Date(), "yyyy-MM-dd"));
                                  ...
                                  direction="row">  
                                    <Grid item xs={12} md={8}>                    
                                        <Autocomplete  
                                            ...
                                            value={OldShiftId ?   ShiftsList.find((item)=> item.id === OldShiftId)   : null}    
                                            onChange={(event, value) =>{ setOldShiftId(value !== null?value.id:0);
                                    ...
                                    <Grid item xs={12}  md={4}>                
                                        <LocalizationProvider dateAdapter={AdapterMoment}>
                                            <DesktopDatePicker
                                                ...
                                                value={OLdFromData}
                                                onChange={(date) => { setOLdFromData(format(new Date(date), "yyyy-MM-dd"));getShiftData(OldShiftId,format(new Date(date), "yyyy-MM-dd"))  ;  }}
