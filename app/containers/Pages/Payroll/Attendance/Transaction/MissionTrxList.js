          ...
          return (
            <div className={style.actionsSty}>
              <IconButton
                ...
                size="large"
              >
                <Link to={{ pathname: "/app/Pages/Att/MissionTrxEdit", state: {id: tableMeta.rowData[0],},}}>
                    <EditIcon />
                  </Link>
              </IconButton>
    ...
    customToolbar: () => (
      <Tooltip title="Add New">
        <Button
          ...
          onClick={() => {
            debugger;
            history.push(`/app/Pages/Att/MissionTrxCreate`);
          }}
          color="secondary"
          className={classes.button}
        >
