...
import { purple, blue, cyan, pink, indigo } from "@mui/material/colors";
...
const colorsPie = [indigo[500], blue[500]];
function OtherActualAttWidget(props) {
      ...
      <PapperBlock whiteBg noMargin title={""} icon="timeline" desc="">
        <Grid item md={12} xs={12}>
          <Typography className={classes.smallTitle} variant="button">
            ...
            <FormattedMessage {...messages.OtherActualAttWidget} />
          </Typography>
...
export default OtherActualAttWidget;
