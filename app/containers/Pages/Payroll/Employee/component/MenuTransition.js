...
function MenuTransition() {
  ...
  const { anchorFade, anchorGrow, anchorZoom } = anchor;
    ...
    <Grid container spacing={2}>
      <Grid item md={4}>
        ...
        >
          ...
          <MenuItem onClick={() => handleClose('anchorFade')}>
            My account
          </MenuItem>
      ...
      <Grid item md={4}>
        ...
        >
          ...
          <MenuItem onClick={() => handleClose('anchorGrow')}>
            My account
          </MenuItem>
      ...
      <Grid item md={4}>
        <div style={{ position: 'relative' }}>
          ...
          >
            <MenuItem onClick={() => handleClose('anchorZoom')}>
              Profile
            </MenuItem>
            <MenuItem onClick={() => handleClose('anchorZoom')}>
              My account
