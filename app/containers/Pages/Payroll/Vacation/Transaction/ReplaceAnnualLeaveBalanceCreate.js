                ...
                <form onSubmit={handleSubmit}>
                    <Grid  container spacing={3}>
                        ...
                        <Grid item xs={12}></Grid>
                            ...
                            <Grid item xs={12} md={12} lg={5.5}  xl={4}  >
                                <Card className={classes.card}>
                                    <CardContent className={style.CardContentSty}>
                                        <Grid 
                                            ...
                                            spacing={3}
                                        >
                                            <Grid item xs={6} md={4}  lg={7} className={`${locale === "ar" ? style.AutocompleteMulFieldStyAR : null}`}>
                                                <Autocomplete
                                                    id="ddlMenu"
                                            ...
                                            <Grid item xs={6} md={4}  lg={5} className={style.gridSty}>
                                                <TextField
                                                    name="Job"
                                                    id="Job"
                                            ...
                                            <Grid item xs={6} md={4}  lg={7} className={style.gridSty}>
                                                <TextField
                                                    name="Department"
                                                    id="Department"
                                            ...
                                            <Grid item xs={6} md={4}  lg={4} className={style.gridSty}>
                                                <TextField
                                                    name="hiringDate"
                                                    id="hiringDate"
                          ...
                          <Grid item xs={12} md={12} lg={6.5} xl={4.8}>
                        <Card className={classes.card}>
                            <CardContent className={style.CardContentSty}>
                                <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={3} lg={4}  xl={3.5}>
                                <Autocomplete
                                    id="ddlMenu"
                            ...
                            <Grid item xs={12} md={3} lg={4} xl={2.5}>
                                <Autocomplete
                                    id="ddlMenu"
                        ...
                        <Grid item xs={12} md={12} lg={6} xl={3.2}  >
                            <Card className={classes.card}>
                                <CardContent className={style.CardContentSty}>
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={3} md={6} lg={5} className={pageStyle.calcBtnSty}>
