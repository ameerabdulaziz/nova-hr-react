          ...
          return (
            <div className={style.actionsSty}>
              <IconButton
                ...
                size="large"
              >
                <Link to={{ pathname: "/app/Pages/HR/EmpCourseEdit", state: {id: tableMeta.rowData[0],},}}>
                    <EditIcon />
                  </Link>
              </IconButton>
    ...
    customToolbar: () => (
      <Tooltip title="Add New">
        <Button
          ...
          onClick={() => {
            debugger;
            history.push(`/app/Pages/HR/EmpCourseCreate`);
          }}
          color="secondary"
          className={classes.button}
        >
