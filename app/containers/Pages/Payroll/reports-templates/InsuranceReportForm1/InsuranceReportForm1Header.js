import {
  ...
  function InsuranceReportForm1Header(props) {
          ...
          <Grid item xs={12}>
            ...
            <div style={{display:"flex", justifyContent:"space-around"}}>
                <div style={{display:"flex"}}>
                        <span>الفئة :</span>
                    <div>
                        <span style={{border:"1px solid #000000", padding:"6px", margin:"0 5px"}}>١</span>
                    </div>

                    <div style={{marginRight:"10px"}}>
                        <span>عاملين لدى الغير :</span>
                        <span style={{border:"1px solid #000000", padding:"0px 10px", margin:"0 5px"}}></span>
                    </div>
                </div>

                <div style={{display:"flex"}}>
                    <div>
                        <span style={{border:"1px solid #000000", padding:"6px", margin:"0 5px"}}>٢</span>
                    </div>
...
//   };
  ...
  export default InsuranceReportForm1Header;
