...
const HrResignRuleList = loadable(
  () => import(
    '../../../Pages/Payroll/HumanResources/Code/hrResignRule'
  ),
  {
    fallback: <Loading />,
  }
...
const HrResignRuleCreate = loadable(
  () => import(
    '../../../Pages/Payroll/HumanResources/Code/hrResignRuleCreate'
  ),
  {
    fallback: <Loading />,
  }
...
const HrResignRuleEdit = loadable(
  () => import(
    '../../../Pages/Payroll/HumanResources/Code/hrResignRuleCreate'
  ),
  {
